# This is a port of the Image class from CellProfiler to maintain compatibility with existing pipelines
...
class Image:
    ...
    * parent_image: if set using the initializer. The child image inherits the
    ...
    def crop_image_similarly(self, image):
        ...
        cropped_image = self.crop_image(image, self.crop_mask)
    ...
    def crop_image(self, image, crop_mask, crop_internal=False):

...
from napari_pipeline.HDF5FileWrapper import HDF5Dict
...
# Relevant constants for wrapper
AGG_MEAN = "Mean"
AGG_STD_DEV = "StDev"
AGG_MEDIAN = "Median"
...
# Relevant functions for wrapper
import tempfile
import time
import pathlib
import threading
...
def make_temporary_file():
    ...
    def get_temporary_directory():
        ...
        if __temp_dir is not None:
            pass
        elif config_exists("TempDir"):
            path = config_read("TempDir")
